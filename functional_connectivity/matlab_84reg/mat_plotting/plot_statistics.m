function plot_statistics(matrix, figure_name, color_range, lunghezza, vet_label)
% Funzione per plottare matrice statistica

% Colori
vet_color = vertcat(lines(7),[1,1,1], [1,0.654,1]);
vet_color = vertcat(vet_color, vet_color);
% Definiamo la figure
...
c2 = colorbar(ax2, 'westoutside', 'Ticks',1.5:19,'TickLabels', vet_label, 'Direction', 'reverse'); 
