function [ICC_matrix] = ICC_pc_84(voxels)
...
for i = 1:voxels
    for k = 1:i
        for m = 1:n_soggetti
            ...
            std_inter_array(1,m) = (pc_t2_matrix_s1200_valzero_norm(i,k) + pc_t2_matrix_sretest_valzero_norm(i,k))/2;
            % Faccio std tra medesima connettività regione del medesimo soggetto nelle
            % due sessioni
            std_intra_array(1,m) = (pc_t2_matrix_s1200_valzero_norm(i,k) - pc_t2_matrix_sretest_valzero_norm(i,k))^2;
        end
